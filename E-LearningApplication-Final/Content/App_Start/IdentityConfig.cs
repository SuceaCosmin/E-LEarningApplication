...
namespace E_LearningApplication_Final
{
    ...
    public class ApplicationUserManager : UserManager<Models.User>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<Models.User>(context.Get<ApplicationDbContext>()));
            ...
            manager.RegisterTwoFactorProvider("Phone Code", new PhoneNumberTokenProvider<Models.User>
            {
                MessageFormat = "Your security code is {0}"
            });
            manager.RegisterTwoFactorProvider("Email Code", new EmailTokenProvider<Models.User>
            {
